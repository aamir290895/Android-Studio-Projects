package com.isracorporations.icareersemploymentnews.services;
...
import com.isracorporations.icareersemploymentnews.R;
...
public class MyFirebaseInstanceService extends FirebaseMessagingService {
    ...
    private void showNotification(Map<String,String> data){
        ...
        String NOTIFICATION_CHANNEL_ID ="com.isracorporations.icareersemploymentnews.services.test";
        ...
        notificationBuilder.setAutoCancel(true).setDefaults(Notification.DEFAULT_ALL).setWhen(System.currentTimeMillis())
                .setSmallIcon(R.drawable.ic_baseline_signal_wifi_off_24).setContentTitle(title)
