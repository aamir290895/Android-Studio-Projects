...
public class AdapterFive extends FirebaseRecyclerAdapter<Model, AdapterFive.MyHolder> {
        String pincode;
/**
 ...
 * @param options
 */
public AdapterFive(@NonNull FirebaseRecyclerOptions<Model> options) {
        super(options);
        }

@Override
protected void onBindViewHolder(@NonNull AdapterFive.MyHolder holder, int position, @NonNull Model model) {
...
@NonNull
@Override
public AdapterFive.MyHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.adapter_five, parent,false);

        return new AdapterFive.MyHolder(view);
...
public class MyHolder extends RecyclerView.ViewHolder {
    ...
    public MyHolder(@NonNull View itemView) {
        super(itemView);
        imageView =itemView.findViewById(R.id.image_five);
        item = itemView.findViewById(R.id.a5);
